 ...
 * 晒单记录
 */
public class ShareProductListFragment extends BaseFragment {
...
//        });
    ...
    public void getData(int position) {
        ...
        RequestService.request(Config.PRODUCT_SHARE_LIST_URL, params, TAG, new RequestCallBack<List<YgShareEntity>>() {
            @Override
