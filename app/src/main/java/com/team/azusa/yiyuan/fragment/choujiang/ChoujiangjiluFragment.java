...
import com.team.azusa.yiyuan.yiyuan_activity.MoreShoppingNumberActivity;
import com.team.azusa.yiyuan.yiyuan_activity.YunRecordDetailActivity;
...
public class ChoujiangjiluFragment extends BaseFragment {
    ...
    @Override
    public int layout() {
        return R.layout.fragment_choujiangjilu;
    }
    ...
    private void initHead() {
        ...
        tv_productname = headView.findViewById(R.id.detail_productname);
            ...
            public void onResponse(HashMap<String, Object> map) {
                ...
                adapter.setOnClickListener(new MyOnClickListener() {
                    ...
                    public void onClick(int position) {
                        Intent intent = new Intent(getContext(), MoreShoppingNumberActivity.class);
