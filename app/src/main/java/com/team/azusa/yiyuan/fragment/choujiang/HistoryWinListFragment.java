 ...
 * 晒单记录
 */
public class HistoryWinListFragment extends BaseFragment {
...
//        });
    ...
    public void getData(int position) {
        ...
        RequestService.request(Config.PRODUCT_HISTORY_WIN_LIST_URL, params, TAG, new RequestCallBack<List<YgShareEntity>>() {
            @Override
